...
define(function(require) {
	...
	// utility method to stop events, covers IE < 9
	Calipso.stopEvent = function(event) {
	...
	Calipso.initializeApp = function(customConfig) {
		...
		Calipso.app.on("initialize:after", function() {
			...
			var pushStateSupported = false;//_.isFunction(history.pushState);
...
//	Calipso.model.UserModel.prototype.getOverviewSchema = function() {
//
//		return [ {
//			name : "metadata",
//			label : "metadata",
...
//	}
	...
	Calipso.components.ViewRowCell = Backgrid.StringCell.extend({
		...
		viewRow : function(e) {
			...
			// Backbone.history.navigate(""+rowModel.get("apiUrlSegment")+"/"+rowModel.get("id"),
			// {
			// trigger : true
			// });
		},
