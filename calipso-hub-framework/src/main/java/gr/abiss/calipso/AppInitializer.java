...
//			textService.create(t3);
	...
	protected void initContinentsAndCountries() {
		...
		Continent SA = continentRepository.save(new Continent("SA", "South America"));
		  ...
		  countryRepository.save(new Country("AE", "United Arab Emirates", "دولة الإمارات العربية المتحدة", "971", AS, "Abu Dhabi", "AED", "ar"));
		  countryRepository.save(new Country("AF", "Afghanistan", "افغانستان", "93", AS, "Kabul", "AFN", "ps,uz,tk"));
		  countryRepository.save(new Country("AG", "Antigua and Barbuda", "Antigua and Barbuda", "1268", NA, "Saint John's", "XCD", "en"));
		  ...
		  countryRepository.save(new Country("BA", "Bosnia and Herzegovina", "Bosna i Hercegovina", "387", EU, "Sarajevo", "BAM", "bs,hr,sr"));
		  ...
		  countryRepository.save(new Country("BF", "Burkina Faso", "Burkina Faso", "226", AF, "Ouagadougou", "XOF", "fr,ff"));
		  ...
		  countryRepository.save(new Country("BL", "Saint Barthélemy", "Saint-Barthélemy", "590", NA, "Gustavia", "EUR", "fr"));
		  countryRepository.save(new Country("BM", "Bermuda", "Bermuda", "1441", NA, "Hamilton", "BMD", "en"));
		  countryRepository.save(new Country("BN", "Brunei", "Negara Brunei Darussalam", "673", AS, "Bandar Seri Begawan", "BND", "ms"));
		  ...
		  countryRepository.save(new Country("CC", "Cocos [Keeling] Islands", "Cocos (Keeling) Islands", "61", AS, "West Island", "AUD", "en"));
		  countryRepository.save(new Country("CD", "Democratic Republic of the Congo", "République démocratique du Congo", "243", AF, "Kinshasa", "CDF", "fr,ln,kg,sw,lu"));
		  countryRepository.save(new Country("CF", "Central African Republic", "Ködörösêse tî Bêafrîka", "236", AF, "Bangui", "XAF", "fr,sg"));
		  countryRepository.save(new Country("CG", "Republic of the Congo", "République du Congo", "242", AF, "Brazzaville", "XAF", "fr,ln"));
		  countryRepository.save(new Country("CH", "Switzerland", "Schweiz", "41", EU, "Bern", "CHE,CHF,CHW", "de,fr,it"));
		  countryRepository.save(new Country("CI", "Ivory Coast", "Côte d'Ivoire", "225", AF, "Yamoussoukro", "XOF", "fr"));
		  ...
		  countryRepository.save(new Country("CW", "Curacao", "Curaçao", "5999", NA, "Willemstad", "ANG", "nl,pa,en"));
		  countryRepository.save(new Country("CX", "Christmas Island", "Christmas Island", "61", AS, "Flying Fish Cove", "AUD", "en"));
		  countryRepository.save(new Country("CY", "Cyprus", "Κύπρος", "357", EU, "Nicosia", "EUR", "el,tr,hy"));
		  countryRepository.save(new Country("CZ", "Czechia", "Česká republika", "420", EU, "Prague", "CZK", "cs,sk"));
		  ...
		  countryRepository.save(new Country("DO", "Dominican Republic", "República Dominicana", "1809,1829,1849", NA, "Santo Domingo", "DOP", "es"));
		  ...
		  countryRepository.save(new Country("EH", "Western Sahara", "الصحراء الغربية", "212", AF, "El Aaiún", "MAD,DZD,MRO", "es"));
		  ...
		  countryRepository.save(new Country("FK", "Falkland Islands", "Falkland Islands", "500", SA, "Stanley", "FKP", "en"));
		  ...
		  countryRepository.save(new Country("GB", "United Kingdom", "United Kingdom", "44", EU, "London", "GBP", "en"));
		  ...
		  countryRepository.save(new Country("GF", "French Guiana", "Guyane française", "594", SA, "Cayenne", "EUR", "fr"));
		  countryRepository.save(new Country("GG", "Guernsey", "Guernsey", "44", EU, "St. Peter Port", "GBP", "en,fr"));
		  ...
		  countryRepository.save(new Country("GP", "Guadeloupe", "Guadeloupe", "590", NA, "Basse-Terre", "EUR", "fr"));
		  countryRepository.save(new Country("GQ", "Equatorial Guinea", "Guinea Ecuatorial", "240", AF, "Malabo", "XAF", "es,fr"));
		  countryRepository.save(new Country("GR", "Greece", "Ελλάδα", "30", EU, "Athens", "EUR", "el"));
		  countryRepository.save(new Country("GS", "South Georgia and the South Sandwich Islands", "South Georgia", "500", AN, "King Edward Point", "GBP", "en"));
		  countryRepository.save(new Country("GT", "Guatemala", "Guatemala", "502", NA, "Guatemala City", "GTQ", "es"));
		  ...
		  countryRepository.save(new Country("IM", "Isle of Man", "Isle of Man", "44", EU, "Douglas", "GBP", "en,gv"));
		  countryRepository.save(new Country("IN", "India", "भारत", "91", AS, "New Delhi", "INR", "hi,en"));
		  countryRepository.save(new Country("IO", "British Indian Ocean Territory", "British Indian Ocean Territory", "246", AS, "Diego Garcia", "USD", "en"));
		  ...
		  countryRepository.save(new Country("KN", "Saint Kitts and Nevis", "Saint Kitts and Nevis", "1869", NA, "Basseterre", "XCD", "en"));
		  ...
		  countryRepository.save(new Country("KY", "Cayman Islands", "Cayman Islands", "1345", NA, "George Town", "KYD", "en"));
		  ...
		  countryRepository.save(new Country("LC", "Saint Lucia", "Saint Lucia", "1758", NA, "Castries", "XCD", "en"));
		  countryRepository.save(new Country("LI", "Liechtenstein", "Liechtenstein", "423", EU, "Vaduz", "CHF", "de"));
		  ...
		  countryRepository.save(new Country("LU", "Luxembourg", "Luxembourg", "352", EU, "Luxembourg", "EUR", "fr,de,lb"));
		  ...
		  countryRepository.save(new Country("ME", "Montenegro", "Црна Гора", "382", EU, "Podgorica", "EUR", "sr,bs,sq,hr"));
		  countryRepository.save(new Country("MF", "Saint Martin", "Saint-Martin", "590", NA, "Marigot", "EUR", "en,fr,nl"));
		  countryRepository.save(new Country("MG", "Madagascar", "Madagasikara", "261", AF, "Antananarivo", "MGA", "fr,mg"));
		  countryRepository.save(new Country("MH", "Marshall Islands", "M̧ajeļ", "692", OC, "Majuro", "USD", "en,mh"));
		  ...
		  countryRepository.save(new Country("NF", "Norfolk Island", "Norfolk Island", "672", OC, "Kingston", "AUD", "en"));
		  ...
		  countryRepository.save(new Country("NZ", "New Zealand", "New Zealand", "64", OC, "Wellington", "NZD", "en,mi"));
		  ...
		  countryRepository.save(new Country("PF", "French Polynesia", "Polynésie française", "689", OC, "Papeetē", "XPF", "fr"));
		  countryRepository.save(new Country("PG", "Papua New Guinea", "Papua Niugini", "675", OC, "Port Moresby", "PGK", "en"));
		  ...
		  countryRepository.save(new Country("PM", "Saint Pierre and Miquelon", "Saint-Pierre-et-Miquelon", "508", NA, "Saint-Pierre", "EUR", "fr"));
		  countryRepository.save(new Country("PN", "Pitcairn Islands", "Pitcairn Islands", "64", OC, "Adamstown", "NZD", "en"));
		  countryRepository.save(new Country("PR", "Puerto Rico", "Puerto Rico", "1787,1939", NA, "San Juan", "USD", "es,en"));
		  ...
		  countryRepository.save(new Country("SA", "Saudi Arabia", "العربية السعودية", "966", AS, "Riyadh", "SAR", "ar"));
		  countryRepository.save(new Country("SB", "Solomon Islands", "Solomon Islands", "677", OC, "Honiara", "SDB", "en"));
		  countryRepository.save(new Country("SC", "Seychelles", "Seychelles", "248", AF, "Victoria", "SCR", "fr,en"));
		  ...
		  countryRepository.save(new Country("SG", "Singapore", "Singapore", "65", AS, "Singapore", "SGD", "en,ms,ta,zh"));
		  countryRepository.save(new Country("SH", "Saint Helena", "Saint Helena", "290", AF, "Jamestown", "SHP", "en"));
		  countryRepository.save(new Country("SI", "Slovenia", "Slovenija", "386", EU, "Ljubljana", "EUR", "sl"));
		  countryRepository.save(new Country("SJ", "Svalbard and Jan Mayen", "Svalbard og Jan Mayen", "4779", EU, "Longyearbyen", "NOK", "no"));
		  countryRepository.save(new Country("SK", "Slovakia", "Slovensko", "421", EU, "Bratislava", "EUR", "sk"));
		  countryRepository.save(new Country("SL", "Sierra Leone", "Sierra Leone", "232", AF, "Freetown", "SLL", "en"));
		  countryRepository.save(new Country("SM", "San Marino", "San Marino", "378", EU, "City of San Marino", "EUR", "it"));
		  ...
		  countryRepository.save(new Country("ST", "São Tomé and Príncipe", "São Tomé e Príncipe", "239", AF, "São Tomé", "STD", "pt"));
		  countryRepository.save(new Country("SV", "El Salvador", "El Salvador", "503", NA, "San Salvador", "SVC,USD", "es"));
		  countryRepository.save(new Country("SX", "Sint Maarten", "Sint Maarten", "1721", NA, "Philipsburg", "ANG", "nl,en"));
		  ...
		  countryRepository.save(new Country("TM", "Turkmenistan", "Türkmenistan", "993", AS, "Ashgabat", "TMT", "tk,ru"));
		  ...
		  countryRepository.save(new Country("TT", "Trinidad and Tobago", "Trinidad and Tobago", "1868", NA, "Port of Spain", "TTD", "en"));
		  ...
		  countryRepository.save(new Country("VA", "Vatican City", "Vaticano", "39066,379", EU, "Vatican City", "EUR", "it,la"));
		  countryRepository.save(new Country("VC", "Saint Vincent and the Grenadines", "Saint Vincent and the Grenadines", "1784", NA, "Kingstown", "XCD", "en"));
		  countryRepository.save(new Country("VE", "Venezuela", "Venezuela", "58", SA, "Caracas", "VEF", "es"));
		  countryRepository.save(new Country("VG", "British Virgin Islands", "British Virgin Islands", "1284", NA, "Road Town", "USD", "en"));
		  countryRepository.save(new Country("VI", "U.S. Virgin Islands", "United States Virgin Islands", "1340", NA, "Charlotte Amalie", "USD", "en"));
		  ...
		  countryRepository.save(new Country("WF", "Wallis and Futuna", "Wallis et Futuna", "681", OC, "Mata-Utu", "XPF", "fr"));
		  countryRepository.save(new Country("WS", "Samoa", "Samoa", "685", OC, "Apia", "WST", "sm,en"));
		  countryRepository.save(new Country("XK", "Kosovo", "Republika e Kosovës", "377,381,386", EU, "Pristina", "EUR", "sq,sr"));
		  ...
		  countryRepository.save(new Country("ZA", "South Africa", "South Africa", "27", AF, "Pretoria", "ZAR", "af,en,nr,st,ss,tn,ts,ve,xh,zu"));
